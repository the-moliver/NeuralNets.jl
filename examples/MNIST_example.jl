...
layer_sizes = [ind, 200, 200, outd]
act   = [donrelu,nrelu, softmaxact];
...
mlp = rmsproptrain(mlp, trainstim, trainval, learning_rate=.001, learning_rate_factor=.995, maxiter=1, batch_size = 100, loss=xent_loss, maxnorm=1.)

mlp = rmsproptrain(mlp, trainstim, trainval, learning_rate=.001, learning_rate_factor=.995, maxiter=100, batch_size = 100, loss=xent_loss,maxnorm=1.)
...
mlp = rmsproptrain(mlp, trainstim, trainval, learning_rate=.001, learning_rate_factor=.98, maxiter=100, batch_size = 100, loss=xent_loss)
